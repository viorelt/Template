 ...
 */
@Mapper(componentModel = "spring", uses = {TVersionMapper.class, EUiMapper.class, EBackendMapper.class, EValueMapper.class})
public interface ElementMapper extends EntityMapper<ElementDTO, Element> {

    @Mapping(source = "tVersion.id", target = "tVersionId")
    ...
    @Mapping(source = "tVersionId", target = "tVersion")
